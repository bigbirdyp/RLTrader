...
if __name__ == '__main__':
    ...
    results = opt_pool.imap(
        optimize_code, [params for _ in range(n_processes)])
    ...
    trader = RLTrader(**params)
    trader.train(test_trained_model=True, render_test_env=True,
                 render_report=True, save_report=True)
